...
```{r}
mpg <- mpg$fuel_type <- if_else(condition = mpg$fl %in% c("p", "r", "d"),
                         true = "petrol", 
...
Lily had Professor Frame. She had a different experience than me in the sense that she learned R coding differently, and their class had fill in the blank questions. She also learned about tidyverse and 
...
Zachary Felix was born on August 30th, 2001. 
